//
// File: _coder_UncontrolInterCollab4so_api.cpp
//
...
emlrtContext emlrtContextGlobal{
    ...
    "UncontrolInterCollab4so",                            // fFunctionName
                                 ...
                                 const mxArray **plhs)
{
  ...
  UncontrolInterCollab4so(numOfVehsInt, *dis2center, *velocity, *accel,
...
void UncontrolInterCollab4so_atexit()
{
  ...
  UncontrolInterCollab4so_xil_terminate();
  UncontrolInterCollab4so_xil_shutdown();
...
//
// File trailer for _coder_UncontrolInterCollab4so_api.cpp
//
// [EOF]
//
