...
traci.start(strcat('sumo-gui -c ./','simpleUncontrolledIntersection.sumocfg --start'));
plotFlag=0;
...
for i = 1:1: duration
    ...
    if i==1
        ...
        switch usecaseNum
            case 1
                traci.vehicle.add('1','1',DEPARTPOS='100',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('2','8',DEPARTPOS='90',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('3','1',DEPARTPOS='80',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('4','8',DEPARTPOS='70',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('5','1',DEPARTPOS='60',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('6','8',DEPARTPOS='50',DEPARTSPEED=num2str(DEPARTSPEEDexample));
            case 2
                traci.vehicle.add('1','1',DEPARTPOS='100',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('2','4',DEPARTPOS='90',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('3','1',DEPARTPOS='80',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('4','4',DEPARTPOS='70',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('5','1',DEPARTPOS='60',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('6','4',DEPARTPOS='50',DEPARTSPEED=num2str(DEPARTSPEEDexample));
            case 3
                traci.vehicle.add('1','5',DEPARTPOS='100',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('2','8',DEPARTPOS='90',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('3','5',DEPARTPOS='80',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('4','8',DEPARTPOS='70',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('5','5',DEPARTPOS='60',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('6','8',DEPARTPOS='50',DEPARTSPEED=num2str(DEPARTSPEEDexample));
            case 4
                traci.vehicle.add('1','5',DEPARTPOS='100',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('2','1',DEPARTPOS='90',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('3','5',DEPARTPOS='80',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('4','1',DEPARTPOS='70',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('5','5',DEPARTPOS='60',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('6','1',DEPARTPOS='50',DEPARTSPEED=num2str(DEPARTSPEEDexample));
            case 5
                traci.vehicle.add('1','9',DEPARTPOS='100',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('2','1',DEPARTPOS='90',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('3','9',DEPARTPOS='80',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('4','1',DEPARTPOS='70',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('5','9',DEPARTPOS='60',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('6','1',DEPARTPOS='50',DEPARTSPEED=num2str(DEPARTSPEEDexample));
            case 6
                traci.vehicle.add('1','9',DEPARTPOS='100',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('2','5',DEPARTPOS='90',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('3','9',DEPARTPOS='80',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('4','5',DEPARTPOS='70',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('5','9',DEPARTPOS='60',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('6','5',DEPARTPOS='50',DEPARTSPEED=num2str(DEPARTSPEEDexample));
            case 7
                traci.vehicle.add('1','4',DEPARTPOS='100',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('2','5',DEPARTPOS='90',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('3','6',DEPARTPOS='80',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('4','4',DEPARTPOS='70',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('5','5',DEPARTPOS='60',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('6','6',DEPARTPOS='50',DEPARTSPEED=num2str(DEPARTSPEEDexample));
            case 8
                traci.vehicle.add('1','1',DEPARTPOS='100',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('2','12',DEPARTPOS='90',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('3','7',DEPARTPOS='80',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('4','6',DEPARTPOS='70',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('5','1',DEPARTPOS='60',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('6','12',DEPARTPOS='50',DEPARTSPEED=num2str(DEPARTSPEEDexample));
            ...
            case 9
                traci.vehicle.add('1','5',DEPARTPOS='110',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('2','12',DEPARTPOS='100',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('3','10',DEPARTPOS='90',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('4','9',DEPARTPOS='80',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('5','4',DEPARTPOS='70',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('6','1',DEPARTPOS='60',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('7','7',DEPARTPOS='50',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('8','6',DEPARTPOS='40',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('9','8',DEPARTPOS='30',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('10','3',DEPARTPOS='20',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('11','2',DEPARTPOS='10',DEPARTSPEED=num2str(DEPARTSPEEDexample));
                traci.vehicle.add('12','11',DEPARTPOS='0',DEPARTSPEED=num2str(DEPARTSPEEDexample));
            otherwise
